...
public class MainActivity extends AppCompatActivity {
    ...
    private MaterialButton button0, button1, button2, button3, button4, button5, button6, button7, button8, button9,
            buttonDot, buttonAdd, buttonSub, buttonMultiply, buttonDivice, buttonPercent, buttonClear, buttonOFF, buttonEqual,
            buttonHistory;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buttonDivice = findViewById(R.id.division);
        ...
        buttonDivice.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                allcalculations();
    ...
    private void saveResultToPref(String firstValue) {
        SharedPreferences sharedPreferences = PreferenceManager.getDefaultSharedPreferences(this);
        SharedPreferences.Editor editor = sharedPreferences.edit();
        String timestamp = String.valueOf(System.currentTimeMillis());
        editor.putString(timestamp, firstValue);
        editor.apply();
    }
    ...
    private void allcalculations() {
        if (!Double.isNaN(firstValue)) {
            ...
            if (currentSymbol == ADDITION) {
                ...
                resultString = String.valueOf(firstValue);
                outputDisplay.setText(resultString);
                saveResultToPref(resultString);
